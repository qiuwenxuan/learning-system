...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      component: () => import('@/views/user/plan/index'),
      name: 'Plan',
      meta: { title: '学习规划', noCache: true, icon: 'guide' }
    },
    {
      path: '/plan/add',
      component: () => import('@/views/user/plan/form'),
      name: 'AddPlan',
      meta: { title: '添加规划', noCache: true, activeMenu: '/plan' },
      hidden: true
    }]
  },

  {
    ...
    children: [{
      ...
      name: 'Post',
      meta: { title: '研友交流', noCache: true, icon: 'guide' }
    },{
        path: '/post/add',
        component: () => import('@/views/user/post/form'),
        name: 'AddPost',
        meta: { title: '添加话题', noCache: true, activeMenu: '/post' },
        hidden: true
      },{
      path: '/post/comment/:id',
      component: () => import('@/views/user/comment/index'),
      name: 'Comment',
      meta: { title: '话题详情', noCache: true, activeMenu: '/post' },
      hidden: true
    }]
  },
